        ...
        <table class="table border table-bordered border-dark bg-light">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $up->isi }}</td>
              <td><a href="/admin/mypost/{{ $up->slug }}" class="btn btn-info fs-6 px-2 py-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="Detail"><i class="bi bi-eye"></i></a></td>
              <td><a href="/admin/mypost/{{ $up->slug }}" class="btn btn-warning fs-6 py-1 px-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="Edit"><i class="bi bi-pencil-square"></i></a></td>
              <td>
